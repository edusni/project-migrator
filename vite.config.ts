...
// Plugin to make CSS non-render-blocking by using media="print" pattern
function asyncCssPlugin(): Plugin {
  return {
    ...
    transformIndexHtml(html) {
      ...
      // This prevents render-blocking while maintaining styles
      return html.replace(
        /<link rel="stylesheet" crossorigin href="([^"]+\.css)">/g,
        '<link rel="stylesheet" crossorigin href="$1" media="print" onload="this.media=\'all\'" data-async-css><noscript><link rel="stylesheet" href="$1"></noscript>'
      );
    },
  };
}
