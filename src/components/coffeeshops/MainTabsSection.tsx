      ...
      <div className="container max-w-6xl">
        <Tabs defaultValue="gedoogbeleid" className="w-full">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 mb-8 md:mb-10">
            <TabsTrigger value="gedoogbeleid" className="text-sm md:text-base">{language === "pt" ? "A Lei" : "The Law"}</TabsTrigger>
            <TabsTrigger value="etiquette" className="text-sm md:text-base">{language === "pt" ? "Etiqueta" : "Etiquette"}</TabsTrigger>
            <TabsTrigger value="menu" className="text-sm md:text-base">{language === "pt" ? "Menu" : "Menu"}</TabsTrigger>
            <TabsTrigger value="neighborhoods" className="text-sm md:text-base">{language === "pt" ? "Bairros" : "Neighborhoods"}</TabsTrigger>
          </TabsList>
            ...
            <div className="space-y-6 md:space-y-8">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {area.warning && (
                        <div className="bg-amber-500/10 p-3 rounded-lg">
                          <p className="text-xs md:text-sm text-amber-800 dark:text-amber-300 flex items-center gap-1">
                      ...
                      <div>
                        <p className="text-xs md:text-sm font-semibold mb-2">{language === "pt" ? "Lojas Notáveis:" : "Notable Shops:"}</p>
                        <div className="flex flex-wrap gap-1">
                          {area.shops.map((shop, i) => (
                            <Badge key={i} variant="outline" className="text-xs md:text-sm">{shop}</Badge>
                          ))}
                        </div>
                      </div>
                    </CardContent>
              ...
              <Card className="border-primary/30">
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-sm md:text-base"><strong>{language === "pt" ? "A Solução:" : "The Solution:"}</strong> {smokerBars.solution}</p>
                  <div className="flex flex-wrap gap-2">
                    {smokerBars.examples.map((ex, i) => (
                      <Badge key={i} variant="secondary" className="text-sm">{ex}</Badge>
                    ))}
                  </div>
                  <p className="text-xs md:text-sm text-muted-foreground italic">{smokerBars.note}</p>
                </CardContent>
              </Card>
