              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4 lg:gap-6 mb-4">
                  <AnimateOnScroll delay={100}>
                    <div className="bg-white/80 dark:bg-black/20 p-4 lg:p-5 rounded-lg">
              ...
              <Card className="bg-white dark:bg-black/40 border-red-200 dark:border-red-800">
                <CardContent className="p-6 lg:p-8">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                    <div className="text-center p-4 lg:p-5 bg-muted/50 rounded-lg">
                    ...
                    <div className="text-center p-4 lg:p-5 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg">
                    ...
                    <div className="text-center p-4 lg:p-5 bg-orange-100 dark:bg-orange-900/30 rounded-lg">
                    ...
                    <div className="text-center p-4 lg:p-5 bg-red-100 dark:bg-red-900/30 rounded-lg border-2 border-red-300 dark:border-red-700">
          ...
          <div className="flex items-start gap-4 lg:gap-6 max-w-6xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-3 text-amber-700 dark:text-amber-300 text-base lg:text-lg">
                ...
                <p className="text-sm lg:text-base bg-amber-100 dark:bg-amber-900/30 p-4 rounded-lg">
                  💡 {language === "pt" 
