      ...
      <div className="container">
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          <h2 className="text-3xl lg:text-5xl font-heading font-bold text-center mb-10">
            📊 {t("Números Para Calibrar Expectativas", "Numbers to Calibrate Expectations", "Cijfers om Verwachtingen te Kalibreren")}
          </h2>
            ...
            <Card className="bg-muted/30">
              <CardContent className="p-8 lg:p-10">
                ...
                <p className="text-base lg:text-lg text-muted-foreground">
                  {t("quartos de hotel em Amsterdam", "hotel rooms in Amsterdam", "hotelkamers in Amsterdam")}
                </p>
              </CardContent>
            </Card>
            <Card className="bg-muted/30">
              <CardContent className="p-8 lg:p-10">
                ...
                <p className="text-base lg:text-lg text-muted-foreground">
                  {t("diária média de hotel (2024-2025)", "average hotel rate (2024-2025)", "gemiddeld hoteltarief (2024-2025)")}
                </p>
              </CardContent>
            </Card>
            <Card className="bg-muted/30">
              <CardContent className="p-8 lg:p-10">
                ...
                <p className="text-base lg:text-lg text-muted-foreground">
                  {t("limite anual de pernoites (meta da prefeitura)", "annual overnight limit (city hall target)", "jaarlijks overnachtingslimiet (doel gemeente)")}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <p className="text-center text-sm lg:text-base text-muted-foreground mt-6">
            {t(
              ...
              "Bronnen: HVS, MMCG, Amsterdam.nl. Tel 2026 belastingen op bij vergelijken."
            )}
          </p>
        </div>
      </div>
